-- Mental Health App Database Migrations (Simplified Version)
-- Copy and paste these commands into your Supabase SQL Editor

-- 1. Create knowledge_base table for RAG system (without vector embeddings for now)
